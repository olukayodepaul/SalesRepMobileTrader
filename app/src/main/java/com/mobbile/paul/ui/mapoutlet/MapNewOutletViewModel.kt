...
class MapNewOutletViewModel @Inject constructor(private val repository: Repository): ViewModel() {
    ...
    fun mapOutlet(repid: Int, tmid: Int, latitude: Double, longitude: Double, outletname: String, contactname: String,
        ...
        repository.mapOutlet(repid,tmid, latitude,longitude,outletname,contactname,outletaddress,contactphone,
